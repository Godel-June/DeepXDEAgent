...
### The previous tool execution results are as follows, including the name of the tool called at each step, parameter information, and the returned result (the type of the result and the specific value), note that when the type of the result returned by the tool is list, its type information is in the form of [the type of the first element, the type of the second element......] to represent:
{previous_steps_info}
